...
// Glow/Bloom Settings
const float DIM_CUTOFF = 0.40; // Threshold for what's considered a dim pixel (default: 0.35)
const float BRIGHT_CUTOFF = 0.1; // Threshold for what's considered a bright pixel
const float BRIGHT_BOOST = 1; // Brightness multiplier for bright pixels (default: 1.2)

const float DIM_GLOW = 0.0015; // Glow intensity for dim pixels (default: 0.05)
const float BRIGHT_GLOW = 0.015; // Glow intensity for bright pixels (default: 0.10)
...
const float MASK_SIZE = 0.42; // Size of the dots (default: 1.0)
